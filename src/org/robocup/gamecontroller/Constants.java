...
public class Constants {
    ...
    public static final int GAMECONTROLLER_RETURN_MSG_REQUEST_PICKUP = 2;
	...
	public static final String HELP = ""
			+ "Usage: java -jar GameController [-port p] [-range r] [-spl] [-hlkid] [-hlteen] [-debug] [-broadcast broadcast_address] cyanTeamNumber magentaTeamNumber\n"
